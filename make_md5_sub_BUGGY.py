...
def main():
    ...
    this_dir, sub_folders = get_sub_folders(dir_list)
    cycle_files(this_dir)
    # Only goes 1 level down
    for folder in sub_folders:
        sub_directory = this_directory + folder + '\\'
        sub_dir_list, sub_folders1 = get_sub_folders(os.listdir(sub_directory))
        cycle_files(sub_dir_list)
