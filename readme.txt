...
The purpose of these programs is to generate and verify a *indexed* sidecar MD5 checksum/hash files for each file in a targeted folder.  These programs do not walk through subfolders at this time. If .md5 files already exist for a given file, make_md5.py does not overwrite them.
